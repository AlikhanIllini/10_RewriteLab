"""
Base settings for RewriteLab project.
...
# This is loaded from .env file - never commit the actual key
...
ROOT_URLCONF = 'rewritelab_project.urls'
...
WSGI_APPLICATION = 'rewritelab_project.wsgi.application'
...
LOGOUT_REDIRECT_URL = 'rewrites:home'
